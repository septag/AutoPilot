...
bool    ImGui_ImplDX11_CreateDeviceObjects()
{
    ...
    // Create the pixel shader
    {
        ...
        static const char* pixelShader =
            ...
            {\
                float4 sRGBColor = texture0.Sample(sampler0, input.uv); \
                float3 linearColor = sRGBColor.xyz*sRGBColor.xyz; \
                linearColor *= sRGBColor.a; \
                float4 out_col = float4(input.col * linearColor, input.col.a*sRGBColor.a); \
                return out_col; \
            }";
#endif
        static const char* pixelShader =
        ...
        ID3DBlob* errorMsg;
        if (FAILED(D3DCompile(pixelShader, strlen(pixelShader), nullptr, nullptr, nullptr, "main", "ps_4_0", 0, 0, &pixelShaderBlob, &errorMsg))) {
